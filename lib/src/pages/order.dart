            ...
            children: <Widget>[
              Row(
                children: <Widget>[
                  ...
                  Helper.getPrice(
                      Helper.getSubTotalOrdersPrice(order: _con.order), context,
                      style: Theme
                          .of(context)
                          .textTheme
                          .subtitle1)
              ...
              Row(
                children: <Widget>[
                  ...
                  Helper.getPrice(
                      Helper.getTotalOrdersPrice(order: _con.order), context,
                      style: Theme
                          .of(context)
                          .textTheme
                          .headline6)
                            ...
                            actions: <Widget>[
                              ...
                              FlatButton(
                                ...
                                new Text(S
                                    ...
                                    !.yes),
                                onPressed: () {
                                  if (_con.order!.orderStatus!.key ==
                                      'driver_assigned') {
                                    _con.order!.orderStatus!.id =
                                    "45";
                                    _con.doDeliveredOrder(
                                        _con.order!);
                                  } else if (_con.order!.orderStatus!.key ==
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Column(
                          ...
                          children: <Widget>[
                            Helper.getPrice(
                                Helper.getTotalOrdersPrice(order: _con.order),
                                context,
                                style: Theme
                                    .of(context)
                                    .textTheme
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Text(
                                _con.order!.foodOrders![0].food!.restaurant!
                                    .name!,
                                style:
                                Theme
                                    .of(context)
                      ...
                      children: <Widget>[
                        Expanded(
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Text(
                                '0${_con.order!.foodOrders![0].food!.restaurant
                                    !.phone}',
                                overflow: TextOverflow.ellipsis,
                                style:
                                Theme
                        ...
                        SizedBox(
                          ...
                          child: FlatButton(
                            ...
                            onPressed: () {
                              launch(
                                  "tel:0${_con.order!.foodOrders![0].food!
                                      .restaurant!.phone}");
                            },
                            child: Icon(
                              Icons.call,
                            ...
                            children: <Widget>[
                              ...
                              Text(
                                _con.order!.user!.name ??
                                    _con.order!.unregisteredCustomer!.name!,
                                style:
                                Theme
                                    .of(context)
                                    .textTheme
                            ...
                            children: <Widget>[
                              ...
                              Text(
                                _con.order!.deliveryAddress!.address ??
                                    _con.order!.deliveryAdd!.address!,
                                style:
                                Theme
                                    .of(context)
                                    .textTheme
